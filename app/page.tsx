        ...
        <div className="space-y-8 lg:pr-8">
          <div className="space-y-4">
            ...
            <p className="text-charcoal text-md leading-relaxed">
              The Climate Intelligence Network (CIN) comprises over 200+ registered and active members representing 20 districts of Sri Lanka. In addition to its nationwide reach, CIN maintains on-the-ground community collaborations in Galle, Nuwara Eliya, Jaffna, Mannar, Colombo, and Batticaloa. 
